...
imgname_a=['./prid2011/cam_a/'];
imgname_b=['./prid2011/cam_b/'];
img_list_a=dir([imgname_a,'*.png']);
img_list_b=dir([imgname_b,'*.png']);
par.nparts=6;
...
a=rand(1,200); [a b]=sort(a);
sampleindex=b(1:100);
sampleindexnext=b(101:end); 
sampleindex_a=1:200; sampleindex_b=1:749;
sampleindex_a(sampleindex)=[];
sampleindex_b(sampleindex)=[];
...
CountOfGalleryTargetSamples=ones(1,649);
CountOfTestingTargetSamples=ones(1,100);
