...
a=rand(1,450); [a b]=sort(a);
sampleindex=b(1:225);
sampleindex_a=b(226:end);
sampleindex_b=b(226:end);
...
CountOfGalleryTargetSamples=ones(1,225);
CountOfTestingTargetSamples=ones(1,225);
